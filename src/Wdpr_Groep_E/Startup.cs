    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddDbContext<WdprContext>(options => options.UseSqlServer(Configuration.GetConnectionString("WdprContext")));
            ...
            // Live database
             services.AddDbContext<WdprContext>(options => options.UseSqlServer("Data Source=SQL5109.site4now.net;Initial Catalog=db_a7f252_aycan070;User Id=db_a7f252_aycan070_admin;Password=Aycan123!;MultipleActiveResultSets=true"));
